...
This tutorial in particular tackles a two anomaly detection cases by using KDE, Gaussian Mixture Processes, and Autoencoders. While the chosen methods do not cover the full spectrum of techniques that can be applied for anomaly detection, they are very effective to highlight the probabilistic reasoning behind anomaly detection as a whole.
...
```sh
git clone https://github.com/a3i-2022-2023/02-ad-advanced
```
